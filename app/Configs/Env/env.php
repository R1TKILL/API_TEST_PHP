...
if ($modeApplication == 'test') {
    $dict_ENV = [
        ...
        'ERROR_DETAILS' => $_ENV['TEST_ERROR_DETAILS'],
    ...
    $dict_ENV = [
        ...
        'ERROR_DETAILS' => $_ENV['DEV_ERROR_DETAILS'],
        'SMTP_HOST' => $_ENV['SMTP_HOST'],
        'SMTP_DEV_TEAM' => $_ENV['SMTP_DEV_TEAM'],
        'SMTP_SENDER' => $_ENV['SMTP_SENDER'],
        'SMTP_PASS' => $_ENV['SMTP_PASS'],
    ...
    $dict_ENV = [
        ...
        'ERROR_DETAILS' => $_ENV['HOMOLOG_ERROR_DETAILS'],
        'SMTP_HOST' => $_ENV['SMTP_HOST'],
        'SMTP_DEV_TEAM' => $_ENV['SMTP_DEV_TEAM'],
        'SMTP_SENDER' => $_ENV['SMTP_SENDER'],
        'SMTP_PASS' => $_ENV['SMTP_PASS'],
    ...
    $dict_ENV = [
        ...
        'ERROR_DETAILS' => $_ENV['PROD_ERROR_DETAILS'],
        'SMTP_HOST' => $_ENV['SMTP_HOST'],
        'SMTP_DEV_TEAM' => $_ENV['SMTP_DEV_TEAM'],
        'SMTP_SENDER' => $_ENV['SMTP_SENDER'],
        'SMTP_PASS' => $_ENV['SMTP_PASS'],
